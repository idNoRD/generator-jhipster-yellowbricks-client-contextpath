...
echo '{"generator-jhipster-yellowbricks-client-contextpath":{"contextPath":"/jh/"}}' > .yo-rc.json
jhipster --blueprints yellowbricks-client-contextpath
```

The generator will patch `src/main/webapp/index.html` and `src/main/webapp/swagger-ui/index.html` during the `POST_WRITING` phase.

### 3. Verify the result

```bash
grep 'base href' src/main/webapp/index.html
grep 'base href' src/main/webapp/swagger-ui/index.html
```
...
```bash
npm unlink -g generator-jhipster-yellowbricks-client-contextpath
```
...
| ------------------ | -------------------------------------- | ------------ |
| `fix:`             | `fix: handle missing base href`        | patch        |
...
2. Add GitHub Actions:
   - Owner: `idNoRD`
   - Repository: `generator-jhipster-yellowbricks-client-contextpath`
